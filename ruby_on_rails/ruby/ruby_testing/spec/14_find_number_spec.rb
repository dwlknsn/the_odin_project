...
describe FindNumber do
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:number_guess) { double('random_number', value: 8) }
      subject(:game) { described_class.new(0, 9, number_guess, 8) }
    ...
    context 'when guess and random_number are not equal' do
      let(:number_guess) { double('random_number', value: 8) }
      subject(:game) { described_class.new(0, 9, number_guess, 5) }
